...
class Window(QWidget):
    ...
    def setup_ui(self):
        ...
        self.label1.setBuddy(self.le_burst_path)
        self.label2.setBuddy(self.le_saving_path)
        self.label3.setBuddy(self.le_imported_path)

        self.btn_burst = QPushButton('打开', self)
        self.btn_saving = QPushButton('打开', self)
        self.btn_import = QPushButton('打开', self)
